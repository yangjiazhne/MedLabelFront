import { Modal, Space, Table, Tag, Progress, Button, Drawer, Empty } from 'antd'
import React, { useState } from 'react'
import { useHistory, useParams } from 'react-router-dom'

const TaskDetailsDrawer = ({ taskDetails, showDrawer, setShowDrawer, reCreateDataset }) => {
  ...
  return (
    <Drawer width="800px" open={showDrawer} onClose={() => setShowDrawer(false)}>
