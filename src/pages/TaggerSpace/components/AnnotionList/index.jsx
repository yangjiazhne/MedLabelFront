...
const AnnotionList = ({changeSession, containerRef, setShowAnnotionList, setShowTagBox}) => {
    const {
        annotion, // 图像的所有标注文件
    ...
    const deleteAnnotationModal = (annotation, image) => {
        Modal.confirm({
            title: '确认',
            icon: <ExclamationCircleOutlined />,
            content: '确定要删除该标注文件吗？',
                            ...
                            {annotion
                                ...
                                <Popover 
                                    ...
                                    <div 
                                        ...
                                        <div className={styles.editAnnotionItem} onClick={()=>{deleteAnnotationModal(item, currentImage)}}>
